...
<html>
    ...
    <body>
        ...
        <div class="container-fluid p-0 m-0">
            ...
            <div class="jumbotron primary-background1 text-white banner-background">
                <div class="container">
                    <h3 class="display-3"> Express Thoughts  </h3>

                    <p>Welcome to Express Thought Blog, world of technology.</p>
                    <p>
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-4">
                    <div class="card" >
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Automation World</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn primary-background text-white">Read more</a>
                        </div>
                    </div>
